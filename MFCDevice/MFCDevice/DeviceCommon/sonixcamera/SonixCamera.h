...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//	FLASH写，写地址最大范围是0-256k空间
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
*	Function:		SonixCam_SerialFlashSectorWrite
*	Description:		先擦除参数addr地址所在的Flash的扇区，地址所在的扇区数据全部被置位0xFF，然后写入数据。
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//	FLASH写，写速度比SonixCam_SerialFlashSectorWrite慢，但是写地址空间更大
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
*	Function:		SonixCam_SerialFlashSectorWrite
*	Description:
...
*	Description:
*	Parameters:		pData：FW Code版本号缓存数组指针，len：缓存数组最大字节数
*	Return :			成功返回	S_OK
*/
...
*				SonixCam_SetParamTableFormFWFile中可以传递函数指针来更新烧录进度
...
*	Description:
*	Parameters:	pFwBuffer：要烧录的固件缓存指针，lFwLength：固件缓存长度， setProgress：烧录进度回调指针， ptrClass：当前类， sft：flash类型， bFullCheckFW：烧录完成后是否进行全校验
*	Return :		成功返回S_OK
*/
...
*	Description:
*	Parameters:	pFwBuffer：要保存固件缓存指针，lFwLength：固件缓存长度， setProgress：导出进度回调指针， ptrClass：当前类
*	Return :		成功返回S_OK
*/
...
*	Parameters:	extendSet：要更改的参数信息，pFwBuffer：固件缓存指针，lFwLength：缓存长度，setProgress：烧录进度回调函数指针， ptrClass：当前类， sft:FLASH类型，bFullCheckFW：是否烧录完成后进行全校验
*	Return :		成功返回S_OK
*/
...
*	Parameters:	pFW：固件缓存指针，lFwLength：缓存长度，setProgress：烧录进度回调函数指针， ptrClass：当前类， sft:FLASH类型，pLogFilePath: Log文件路径， bFullCheckFW：是否烧录完成后进行全校验
*	Return :		成功返回S_OK
*/
