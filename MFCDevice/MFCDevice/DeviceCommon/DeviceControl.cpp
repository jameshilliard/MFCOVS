...
HRESULT DeviceControl::OpenDevice()
{
	HRESULT ret = NOERROR;
...
HRESULT DeviceControl::CloseDevice()
{
	HRESULT ret = NOERROR;
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::Set_CompressionRatio(string val)
{
	HRESULT ret = NOERROR;
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::Get_CompressionRatio(string& val)
{
	HRESULT ret = NOERROR;
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::COMS_Gain_High_1_bit_Write(string val)
{
	HRESULT ret = NOERROR;
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::COMS_Gain_Low_8_bit_Write(string val)
{
	HRESULT ret = NOERROR;
	unsigned short Addr_H;
	unsigned short Addr_L;
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::COMS_Gain_Low_8_bit_Read(string& val)
{
	HRESULT ret = NOERROR;
	unsigned short Addr_H;
	unsigned short Addr_L;
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::COMS_Exposure_High_8_bit_Write(string val)
{
	HRESULT ret = NOERROR;
	unsigned short Addr_H;
	unsigned short Addr_L;
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::COMS_Exposure_Middle_8_bit_Write(string val)
{
	HRESULT ret = NOERROR;
	unsigned short Addr_H;
	unsigned short Addr_L;
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::COMS_Exposure_Middle_8_bit_Read(string& val)
{
	HRESULT ret = NOERROR;
	unsigned short Addr_H;
	unsigned short Addr_L;
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::COMS_Exposure_Low_8_bit_Write(string val)
{
	HRESULT ret = NOERROR;
	unsigned short Addr_H;
	unsigned short Addr_L;
...
void DeviceControl::Dec2Hex(int x, string& in_str)
{
	stringstream ss;
	ss << hex << x;
	ss >> in_str;
...
void DeviceControl::Dec2HexK(int x, string& in_str)
{
	stringstream ss;
...
void DeviceControl::Dec2HexP(int x, string& in_str)
{
	stringstream ss;
	ss << hex << x;
	ss >> in_str;
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::Set_Exposure(string val) //只调节中8位
{
	HRESULT ret = NOERROR;
	//ret = Enable_Distance_Function(false);
	//if (ret != S_OK)
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::Get_Exposure(string& val)
{
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::Set_Gain(string val)//只调节低8位
{
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::Get_Gain(string& val)
{
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::Set_LEDCurrent(string val)
{
	HRESULT ret = NOERROR;
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::Get_LEDCurrent(string& val)
{
	HRESULT ret = NOERROR;
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::Set_BL(string val)
{
	HRESULT ret = NOERROR;
	ret = AsicRegisterWrite(COMS_BLACK_LEVEL_ADDR, "00", 1);
	return ret;
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//	读当前黑电平值
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::Get_BL(string& val)
{
	HRESULT ret = NOERROR;
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::Enable_DSP_Function(bool enable)
{
	HRESULT ret = NOERROR;
	if (enable)
	{
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::Enable_Distance_Function(bool enable)
{
	HRESULT ret = NOERROR;
	if (enable)
	{
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::Get_Distance(string& val)
{
	HRESULT ret = NOERROR;
	//ret = Enable_Distance_Function(false);
	//if (ret != S_OK)
...
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT DeviceControl::AsicRegisterWrite(unsigned short addr, string val, int len)
{
	HRESULT ret = NOERROR;
...
HRESULT DeviceControl::AsicRegisterRead(unsigned short addr, string& val, int len)
{
	HRESULT ret = NOERROR;
	BYTE* pData = new BYTE[len];
	memset(pData, 0xff, len);
