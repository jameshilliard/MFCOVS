...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
*	Function:		COMS_BL_8_bit_Write
*	Description:
*	Parameters:		Val：BL（0x00 0x10），默认值0x10, 关；
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT OVSDevice::COMS_BL_8_bit_Write(string val)
{
	HRESULT ret = NOERROR;
	unsigned short Addr_H;
	unsigned short Addr_L;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
*	Function:		COMS_BL_8_bit_Read
*	Description:
*	Parameters:		Val：BL（0x00 0x10），默认值0x10, 关；
*	Return :		成功返回	S_OK, 失败返回:NOERROR
*/
HRESULT OVSDevice::COMS_BL_8_bit_Read(string& val)
{
	HRESULT ret = NOERROR;
	unsigned short Addr_H;
	unsigned short Addr_L;
